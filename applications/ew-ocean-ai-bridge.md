...
* Integrate EW-DOS with EW-AI
* Have devices send their PTD data into EW-AI API
* Define who can access their data, costs in OCEAN, etc.

- DATA CONSUMERS (these could be the same vendors, or even 3rd parties)
* Register with EW-AI Marketplace
* Search/Find IOT PTD data sets (this can also be done via filtering, grouping, aggregation, normalization, etc. search by manufacturer, device, type, data captured, etc.)
* Have EW-AI prepare those sets for OCEAN (EW-AI handles all the details here)
* Apply learning
* Get results -> make their devices more efficient.
